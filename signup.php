    ...
    <button type="submit" name="submit">Sign up</button>
        ...
        if (isset($_GET["error"])){
            if($_GET["error"] == "emptyinput"){
                ...
                echo "<p>Use proper gmail account!</p>";
            }
            else if ($_GET["error"] == "invalidfirstname"){
                echo "<p>Use proper  first name!</p>";
            }
            else if ($_GET["error"] == "invalidlastname"){
                echo "<p>Use proper last name!</p>";
            }
            else if ($_GET["error"] == "invalidphonenumber"){
                echo "<p>Use proper phone number!</p>";
            }
            else if ($_GET["error"] == "invalidaddress"){
                echo "<p>Use proper address!</p>";
            }
            else if ($_GET["error"] == "invalidpassword"){
                echo "<p>Use proper password!</p>";
            }
        }
